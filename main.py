...
def restore_from_local():
    ...
    ssh.exec_command("chmod 775 -R /var/www/html/ && tar -xzvf /home/philippe/P6/backup/" + file_to_restore + " -C /var/www/html/")
    os.system("sleep 5")
    ...
    #ssh.exec_command("sudo cp -rf /home/philippe/P6/backup/* /var/www/html/backup")
